    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		...
    		h() {
    			...
    			attr(path0, "class", "svelte-18ffu7g");
    			...
    			attr(path1, "class", "svelte-18ffu7g");
    			...
    			attr(svg, "class", "modal_icon svelte-18ffu7g");
    			attr(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr(svg, "viewBox", "0 0 28 29");
    			attr(svg, "fill", "none");
    			attr(button, "class", button_class_value = "clue " + /*custom*/ ctx[2] + " svelte-18ffu7g");
    			...
    			attr(li, "class", li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[9]) + " svelte-18ffu7g"));
    		},
    		m(target, anchor) {
