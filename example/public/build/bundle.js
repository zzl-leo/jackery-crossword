...
var app = (function () {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (x === undefined && !('x' in $$props || $$self.$$.bound[$$self.$$.props['x']])) {
    			console_1$4.warn("<Cell> was created without expected prop 'x'");
    		}

    		if (y === undefined && !('y' in $$props || $$self.$$.bound[$$self.$$.props['y']])) {
    			console_1$4.warn("<Cell> was created without expected prop 'y'");
    		}

    		if (value === undefined && !('value' in $$props || $$self.$$.bound[$$self.$$.props['value']])) {
    			console_1$4.warn("<Cell> was created without expected prop 'value'");
    		}

    		if (answer === undefined && !('answer' in $$props || $$self.$$.bound[$$self.$$.props['answer']])) {
    			console_1$4.warn("<Cell> was created without expected prop 'answer'");
    		}

    		if (number === undefined && !('number' in $$props || $$self.$$.bound[$$self.$$.props['number']])) {
    			console_1$4.warn("<Cell> was created without expected prop 'number'");
    		}

    		if (index === undefined && !('index' in $$props || $$self.$$.bound[$$self.$$.props['index']])) {
    			console_1$4.warn("<Cell> was created without expected prop 'index'");
    		}

    		if (custom === undefined && !('custom' in $$props || $$self.$$.bound[$$self.$$.props['custom']])) {
    			console_1$4.warn("<Cell> was created without expected prop 'custom'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$4.warn(`<Cell> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path0, file$7, 154, 8, 6183);
    			...
    			add_location(path1, file$7, 155, 8, 6640);
    			attr_dev(g, "clip-path", "url(#clip0_1554_302)");
    			add_location(g, file$7, 153, 6, 6138);
    			...
    			add_location(rect, file$7, 159, 10, 7923);
    			attr_dev(clipPath, "id", "clip0_1554_302");
    			add_location(clipPath, file$7, 158, 8, 7882);
    			add_location(defs, file$7, 157, 6, 7867);
    			attr_dev(svg, "class", "modal_icon svelte-1loojzy");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 28 29");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$7, 152, 4, 6040);
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	function handleShare(params) {
    		...
    		switch (share__type) {
    			...
    			case 'messenger':
    				if (checkMobile()) {
    					window.open(`fb-messenger://share/?link=https://jackery-crossword.vercel.app/`, '单独窗口', 'height=500,width=600,top=30,left=20,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');
    				} else {
    					FB.ui({
    						method: 'send',
    ...
    function create_if_block$1(ctx) {
    	...
    	const message_slot = create_slot(message_slot_template, ctx, /*$$scope*/ ctx[7], get_message_slot_context$1);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file$3, 32, 6, 1531);
    			attr_dev(div1, "class", "content svelte-1tc2o1u");
    			add_location(div1, file$3, 31, 4, 1503);
    			attr_dev(div2, "class", "footer");
    			add_location(div2, file$3, 49, 4, 1834);
    			attr_dev(div3, "class", "completed svelte-1tc2o1u");
    			add_location(div3, file$3, 26, 2, 562);
    			attr_dev(div4, "class", "curtain svelte-1tc2o1u");
    			add_location(div4, file$3, 60, 2, 2062);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div4, "click", /*close*/ ctx[5], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			...
    			if (message_slot) {
    				if (message_slot.p && (!current || dirty & /*$$scope*/ 128)) {
    					update_slot_base(
    						message_slot,
    						...
    						: get_slot_changes(message_slot_template, /*$$scope*/ ctx[7], dirty, get_message_slot_changes$1),
    ...
    function create_if_block_5$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path, file$3, 28, 191, 830);
    			...
    			add_location(svg, file$3, 28, 4, 643);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, svg, anchor);
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(button, file$3, 37, 8, 1633);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, button, anchor);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$3, 54, 6, 1925);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('funcClose' in $$props) $$invalidate(6, funcClose = $$props.funcClose);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$1, 230, 4, 6338);
    			...
    			add_location(article, file$1, 216, 2, 5939);
    		},
    		m: function mount(target, anchor) {
    ...
    // (258:4) {#if isComplete && !isRevealing && showCompleteMessage}
    function create_if_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(258:4) {#if isComplete && !isRevealing && showCompleteMessage}",
    		ctx
    	});
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h3, file$1, 261, 10, 7440);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(261:10) {#if coupons_api_error === \\\"\\\"}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h3, "class", "title_gameend svelte-wose4r");
    			add_location(h3, file$1, 272, 12, 7977);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, h3, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(272:10) {#if coupons_api_error !== \\\"\\\"}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(br, file$1, 279, 61, 8253);
    			attr_dev(div, "class", "footer_gameend svelte-wose4r");
    			add_location(div, file$1, 278, 10, 8163);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(278:10) {#if coupons_api_error === \\\"\\\"}",
    		ctx
    	});
    ...
    // (288:4) {#if !isComplete && !isRevealing && !isSubscribe}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(288:4) {#if !isComplete && !isRevealing && !isSubscribe}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path, file$1, 306, 171, 9592);
    			...
    			attr_dev(svg, "fill", "currentColor");
    			attr_dev(svg, "aria-hidden", "true");
    			add_location(svg, file$1, 306, 16, 9437);
    			attr_dev(span, "class", "crossword_submit_loading svelte-wose4r");
    			add_location(span, file$1, 305, 14, 9381);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(305:14) {#if subscribeLoading}",
    		ctx
    	});
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path0, file$1, 313, 14, 10177);
    			...
    			add_location(path1, file$1, 314, 14, 10724);
    			...
    			add_location(path2, file$1, 315, 14, 10935);
    			...
    			add_location(path3, file$1, 316, 14, 11259);
    			...
    			add_location(path4, file$1, 317, 14, 11530);
    			...
    			add_location(path5, file$1, 318, 14, 11757);
    			...
    			add_location(path6, file$1, 319, 14, 12100);
    			...
    			add_location(path7, file$1, 320, 14, 12438);
    			...
    			add_location(path8, file$1, 321, 14, 12670);
    			...
    			add_location(path9, file$1, 322, 14, 12963);
    			...
    			add_location(path10, file$1, 323, 14, 13222);
    			...
    			add_location(path11, file$1, 324, 14, 13494);
    			...
    			add_location(path12, file$1, 325, 14, 13847);
    			...
    			add_location(path13, file$1, 326, 14, 14033);
    			...
    			add_location(path14, file$1, 327, 14, 14382);
    			...
    			add_location(path15, file$1, 328, 14, 14529);
    			...
    			add_location(path16, file$1, 329, 14, 14740);
    			...
    			add_location(path17, file$1, 330, 14, 15029);
    			...
    			add_location(path18, file$1, 331, 14, 15223);
    			...
    			add_location(path19, file$1, 332, 14, 15408);
    			...
    			add_location(path20, file$1, 333, 14, 15571);
    			...
    			add_location(path21, file$1, 334, 14, 15782);
    			...
    			add_location(path22, file$1, 335, 14, 16185);
    			...
    			add_location(path23, file$1, 336, 14, 16362);
    			...
    			add_location(path24, file$1, 337, 14, 16790);
    			...
    			add_location(path25, file$1, 338, 14, 16998);
    			...
    			add_location(path26, file$1, 339, 14, 17337);
    			...
    			add_location(path27, file$1, 340, 14, 17622);
    			...
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$1, 312, 12, 10030);
    			attr_dev(div2, "class", "crossword_subscribe_container svelte-wose4r");
    			add_location(div2, file$1, 291, 10, 8716);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div2, anchor);
