var app = (function () {
    ...
    // (219:4) {#each cells as { x, y, value, answer, index, number, custom }}
    function create_each_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(219:4) {#each cells as { x, y, value, answer, index, number, custom }}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$8, 243, 2, 7447);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(243:0) {#if keyboardVisible}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(svg, file$8, 217, 2, 6554);
    			...
    			add_location(section, file$8, 212, 0, 6454);
    		},
    		m: function mount(target, anchor) {
    ...
    var tips = [
    	...
    	},
    	{
    		...
    		des: "Mobiles Gerät für Strom unterwegs."
    	},
    	{
    	...
    	{
    		title: "WORT:  EXPLORER",
    		des: "Mit Jackery gemeinsam die Welt entdecken"
    	},
    	{
    		title: "WORD: CAMPING",
    		des: "Jackery Solargeneratoren sind für den Einsatz im Freien und liefern tragbaren Strom für Ihre Outdoor-Geräte wie z.B. CPAP, Elektrogrill und Airfryer!"
    	},
    	{
    		title: "WORT: SOLARGENERATOR",
    		des: "Ein Solarstromsystem, das eine tragbare Powerstation mit einem Solarpanel kombiniert. Es stößt keine giftigen Gase aus und arbeitet äußerst sauber - ohne die Umwelt zu belasten."
    	}
    ];
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(path0, "class", "svelte-18ffu7g");
    			add_location(path0, file$7, 160, 8, 6628);
    			...
    			attr_dev(path1, "class", "svelte-18ffu7g");
    			add_location(path1, file$7, 161, 8, 7085);
    			attr_dev(g, "clip-path", "url(#clip0_1554_302)");
    			add_location(g, file$7, 159, 6, 6583);
    			...
    			add_location(rect, file$7, 165, 10, 8368);
    			attr_dev(clipPath, "id", "clip0_1554_302");
    			add_location(clipPath, file$7, 164, 8, 8327);
    			add_location(defs, file$7, 163, 6, 8312);
    			attr_dev(svg, "class", "modal_icon svelte-18ffu7g");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 28 29");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$7, 158, 4, 6485);
    			attr_dev(button, "class", button_class_value = "clue " + /*custom*/ ctx[2] + " svelte-18ffu7g");
    			...
    			add_location(button, file$7, 147, 2, 6138);
    			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[9]) + " svelte-18ffu7g"));
    			add_location(li, file$7, 146, 0, 6002);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*custom*/ 4 && button_class_value !== (button_class_value = "clue " + /*custom*/ ctx[2] + " svelte-18ffu7g")) {
    				attr_dev(button, "class", button_class_value);
    			}
    			...
    			if (dirty & /*clueClass*/ 512 && li_class_value !== (li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[9]) + " svelte-18ffu7g"))) {
