...
var app = (function () {
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(line, file$9, 111, 4, 2497);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(111:2) {#if showCheck && !correct}",
    		ctx
    	});
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(text_1, file$9, 115, 4, 2566);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(g, file$9, 97, 0, 2066);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (x === undefined && !('x' in $$props || $$self.$$.bound[$$self.$$.props['x']])) {
    			console_1$3.warn("<Cell> was created without expected prop 'x'");
    		}

    		if (y === undefined && !('y' in $$props || $$self.$$.bound[$$self.$$.props['y']])) {
    			console_1$3.warn("<Cell> was created without expected prop 'y'");
    		}

    		if (value === undefined && !('value' in $$props || $$self.$$.bound[$$self.$$.props['value']])) {
    			console_1$3.warn("<Cell> was created without expected prop 'value'");
    		}

    		if (answer === undefined && !('answer' in $$props || $$self.$$.bound[$$self.$$.props['answer']])) {
    			console_1$3.warn("<Cell> was created without expected prop 'answer'");
    		}

    		if (number === undefined && !('number' in $$props || $$self.$$.bound[$$self.$$.props['number']])) {
    			console_1$3.warn("<Cell> was created without expected prop 'number'");
    		}

    		if (index === undefined && !('index' in $$props || $$self.$$.bound[$$self.$$.props['index']])) {
    			console_1$3.warn("<Cell> was created without expected prop 'index'");
    		}

    		if (custom === undefined && !('custom' in $$props || $$self.$$.bound[$$self.$$.props['custom']])) {
    			console_1$3.warn("<Cell> was created without expected prop 'custom'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$3.warn(`<Cell> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path0, file$7, 162, 8, 6778);
    			...
    			add_location(path1, file$7, 163, 8, 7235);
    			attr_dev(g, "clip-path", "url(#clip0_1554_302)");
    			add_location(g, file$7, 161, 6, 6733);
    			...
    			add_location(rect, file$7, 167, 10, 8518);
    			attr_dev(clipPath, "id", "clip0_1554_302");
    			add_location(clipPath, file$7, 166, 8, 8477);
    			add_location(defs, file$7, 165, 6, 8462);
    			attr_dev(svg, "class", "modal_icon svelte-1loojzy");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 28 29");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$7, 160, 4, 6635);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*custom*/ 4 && button_class_value !== (button_class_value = "clue " + /*custom*/ ctx[2] + " svelte-1loojzy")) {
    				attr_dev(button, "class", button_class_value);
    			}
    			...
    			if (dirty & /*clueClass*/ 512 && li_class_value !== (li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[9]) + " svelte-1loojzy"))) {
    ...
    function create_if_block$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*showCloseBtn*/ ctx[3] && create_if_block_5$1(ctx);
    	...
    	let if_block1 = /*outClickClose*/ ctx[1] && create_if_block_2$1(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "message svelte-gxknb4");
    			add_location(div0, file$3, 44, 6, 1796);
    			attr_dev(div1, "class", "content svelte-gxknb4");
    			add_location(div1, file$3, 43, 4, 1768);
    			attr_dev(div2, "class", "footer");
    			add_location(div2, file$3, 62, 4, 2212);
    			attr_dev(div3, "class", "completed svelte-gxknb4");
    			add_location(div3, file$3, 38, 2, 827);
    			attr_dev(div4, "class", "curtain 888 svelte-gxknb4");
    			add_location(div4, file$3, 73, 2, 2440);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_5$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path, file$3, 40, 191, 1095);
    			attr_dev(svg, "class", "close_icon svelte-gxknb4");
    			...
    			add_location(svg, file$3, 40, 4, 908);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, svg, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(svg, "click", /*close*/ ctx[5], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (49:6) {#if outClickClose}
    function create_if_block_2$1(ctx) {
    	let button;
    	let t;
    	let mounted;
    	let dispose;
    	let if_block0 = /*btnShopNow*/ ctx[2] && create_if_block_4$1(ctx);
    	let if_block1 = !/*btnShopNow*/ ctx[2] && create_if_block_3$1(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(button, "class", "svelte-gxknb4");
    			add_location(button, file$3, 49, 8, 1898);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, button, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*close*/ ctx[5], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block_4$1(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t = claim_text(span_nodes, "SHOP NOW");
    			span_nodes.forEach(detach_dev);
    			this.h();
    		},
    		h: function hydrate() {
    			attr_dev(span, "class", "svelte-gxknb4");
    			add_location(span, file$3, 52, 12, 2034);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span, "click", /*handleGTM_shopnow*/ ctx[6], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "confetti svelte-gxknb4");
    			add_location(div, file$3, 67, 6, 2303);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function handleGTM_shopnow() {
    		handleGameGTM({ button_name: "SHOP NOW" });
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('btnShopNow' in $$props) $$invalidate(2, btnShopNow = $$props.btnShopNow);
    		if ('showCloseBtn' in $$props) $$invalidate(3, showCloseBtn = $$props.showCloseBtn);
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			var div0_nodes = children(div0);
    			t3 = claim_text(div0_nodes, "CODE: ");
    			t4 = claim_text(div0_nodes, /*coupons_code*/ ctx[25]);
    			div0_nodes.forEach(detach_dev);
    			t5 = claim_space(div2_nodes);
    			div1 = claim_element(div2_nodes, "DIV", { class: true });
    			var div1_nodes = children(div1);
    			t6 = claim_text(div1_nodes, "2% off stackable coupon");
    			div1_nodes.forEach(detach_dev);
    			div2_nodes.forEach(detach_dev);
    			div3_nodes.forEach(detach_dev);
    			this.h();
    		...
    		h: function hydrate() {
    			attr_dev(h3, "class", "title_gameend svelte-wose4r");
    			add_location(h3, file$1, 265, 10, 7572);
    			...
    			attr_dev(img, "class", "svelte-wose4r");
    			add_location(img, file$1, 267, 12, 7715);
    			attr_dev(div0, "class", "coupone_info_title svelte-wose4r");
    			add_location(div0, file$1, 269, 14, 7870);
    			attr_dev(div1, "class", "coupone_info_des svelte-wose4r");
    			add_location(div1, file$1, 270, 14, 7943);
    			attr_dev(div2, "class", "coupone_info svelte-wose4r");
    			add_location(div2, file$1, 268, 12, 7829);
    			attr_dev(div3, "class", "coupon_gameend svelte-wose4r");
    			add_location(div3, file$1, 266, 10, 7674);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			h3 = claim_element(nodes, "H3", { class: true });
    			var h3_nodes = children(h3);
    			t = claim_text(h3_nodes, /*coupons_api_error*/ ctx[24]);
    			h3_nodes.forEach(detach_dev);
    			this.h();
    		},
    		h: function hydrate() {
    			attr_dev(h3, "class", "title_gameend svelte-wose4r");
    			add_location(h3, file$1, 276, 12, 8109);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, h3, anchor);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(br, file$1, 283, 61, 8385);
    			attr_dev(div, "class", "footer_gameend svelte-wose4r");
    			add_location(div, file$1, 282, 10, 8295);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path, file$1, 310, 171, 9732);
    			attr_dev(svg, "class", "anticon-loading svelte-wose4r");
    			...
    			attr_dev(svg, "fill", "currentColor");
    			attr_dev(svg, "aria-hidden", "true");
    			add_location(svg, file$1, 310, 16, 9577);
    			attr_dev(span, "class", "crossword_submit_loading svelte-wose4r");
    			add_location(span, file$1, 309, 14, 9521);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, span, anchor);
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(br, file$1, 297, 53, 8970);
    			attr_dev(strong, "class", "svelte-wose4r");
    			add_location(strong, file$1, 298, 24, 8999);
    			attr_dev(h3, "class", "svelte-wose4r");
    			add_location(h3, file$1, 296, 12, 8912);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Email");
    			attr_dev(input, "class", "svelte-wose4r");
    			add_location(input, file$1, 300, 12, 9055);
    			attr_dev(div0, "class", "error__tips svelte-wose4r");
    			toggle_class(div0, "active", /*subscribe_error*/ ctx[20]);
    			add_location(div0, file$1, 301, 12, 9189);
    			attr_dev(div1, "class", "crossword_subscribe_submit svelte-wose4r");
    			toggle_class(div1, "loading", /*subscribeLoading*/ ctx[23]);
    			add_location(div1, file$1, 302, 12, 9287);
    			...
    			add_location(path0, file$1, 317, 14, 10317);
    			...
    			add_location(path1, file$1, 318, 14, 10864);
    			...
    			add_location(path2, file$1, 319, 14, 11075);
    			...
    			add_location(path3, file$1, 320, 14, 11399);
    			...
    			add_location(path4, file$1, 321, 14, 11670);
    			...
    			add_location(path5, file$1, 322, 14, 11897);
    			...
    			add_location(path6, file$1, 323, 14, 12240);
    			...
    			add_location(path7, file$1, 324, 14, 12578);
    			...
    			add_location(path8, file$1, 325, 14, 12810);
    			...
    			add_location(path9, file$1, 326, 14, 13103);
    			...
    			add_location(path10, file$1, 327, 14, 13362);
    			...
    			add_location(path11, file$1, 328, 14, 13634);
    			...
    			add_location(path12, file$1, 329, 14, 13987);
    			...
    			add_location(path13, file$1, 330, 14, 14173);
    			...
    			add_location(path14, file$1, 331, 14, 14522);
    			...
    			add_location(path15, file$1, 332, 14, 14669);
    			...
    			add_location(path16, file$1, 333, 14, 14880);
    			...
    			add_location(path17, file$1, 334, 14, 15169);
    			...
    			add_location(path18, file$1, 335, 14, 15363);
    			...
    			add_location(path19, file$1, 336, 14, 15548);
    			...
    			add_location(path20, file$1, 337, 14, 15711);
    			...
    			add_location(path21, file$1, 338, 14, 15922);
    			...
    			add_location(path22, file$1, 339, 14, 16325);
    			...
    			add_location(path23, file$1, 340, 14, 16502);
    			...
    			add_location(path24, file$1, 341, 14, 16930);
    			...
    			add_location(path25, file$1, 342, 14, 17138);
    			...
    			add_location(path26, file$1, 343, 14, 17477);
    			...
    			add_location(path27, file$1, 344, 14, 17762);
    			attr_dev(svg, "class", "crossword_subscribe_icon svelte-wose4r");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "width", "101");
    			attr_dev(svg, "height", "178");
    			attr_dev(svg, "viewBox", "0 0 101 178");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$1, 316, 12, 10170);
    			attr_dev(div2, "class", "crossword_subscribe_container svelte-wose4r");
    			add_location(div2, file$1, 295, 10, 8856);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div2, anchor);
