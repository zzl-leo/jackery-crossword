...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$8, 226, 2, 6955);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(svg, file$8, 200, 2, 6062);
    			...
    			add_location(section, file$8, 195, 0, 5962);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<Puzzle> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path0, file$7, 59, 8, 2549);
    			...
    			add_location(path1, file$7, 60, 8, 3006);
    			attr_dev(g, "clip-path", "url(#clip0_1554_302)");
    			add_location(g, file$7, 58, 6, 2504);
    			...
    			add_location(rect, file$7, 64, 10, 4289);
    			attr_dev(clipPath, "id", "clip0_1554_302");
    			add_location(clipPath, file$7, 63, 8, 4248);
    			add_location(defs, file$7, 62, 6, 4233);
    			attr_dev(svg, "class", "modal_icon svelte-1navz17");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 28 29");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$7, 57, 4, 2406);
    			attr_dev(button, "class", button_class_value = "clue " + /*custom*/ ctx[0] + " svelte-1navz17");
    			toggle_class(button, "is-disable-highlight", /*isDisableHighlight*/ ctx[4]);
    			...
    			toggle_class(button, "is-filled", /*isFilled*/ ctx[1]);
    			add_location(button, file$7, 45, 2, 1258);
    			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[7]) + " svelte-1navz17"));
    			add_location(li, file$7, 44, 0, 1161);
    		},
    		m: function mount(target, anchor) {
    			...
    			/*li_binding*/ ctx[13](li);

    			if (!mounted) {
    				dispose = [
    					listen_dev(button, "click", /*handleOpenHelp*/ ctx[9], false, false, false, false),
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*custom*/ 1 && button_class_value !== (button_class_value = "clue " + /*custom*/ ctx[0] + " svelte-1navz17")) {
    				attr_dev(button, "class", button_class_value);
    			}

    			if (dirty & /*custom, isDisableHighlight*/ 17) {
    				toggle_class(button, "is-disable-highlight", /*isDisableHighlight*/ ctx[4]);
    			}

    			if (dirty & /*custom, isNumberFocused*/ 5) {
    				toggle_class(button, "is-number-focused", /*isNumberFocused*/ ctx[2]);
    			}

    			if (dirty & /*custom, isDirectionFocused*/ 9) {
    				toggle_class(button, "is-direction-focused", /*isDirectionFocused*/ ctx[3]);
    			}

    			if (dirty & /*custom, isFilled*/ 3) {
    				toggle_class(button, "is-filled", /*isFilled*/ ctx[1]);
    			}

    			if (dirty & /*clueClass*/ 128 && li_class_value !== (li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[7]) + " svelte-1navz17"))) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	function handleOpenHelp() {
    		Modal.getInstance(`<h1 id="xxl">345</h1>`, {
    			header: "想要解锁活动提示？您需要点击下列按钮分享这个游戏到社媒",
    			id: `cell_modal_${clueClass}`,
    			class: "",
    			cb: el => {
    				el.querySelector("#xxl").removeEventListener("click", () => {
    					handleShare(el);
    				});

    				setTimeout(
    					() => {
    						el.querySelector("#xxl").addEventListener("click", () => {
    							handleShare(el);
    						});
    					},
    					0
    	...
    	$$self.$$.on_mount.push(function () {
    		if (number === undefined && !('number' in $$props || $$self.$$.bound[$$self.$$.props['number']])) {
    			console_1$1.warn("<Clue> was created without expected prop 'number'");
    		}

    		if (direction === undefined && !('direction' in $$props || $$self.$$.bound[$$self.$$.props['direction']])) {
    			console_1$1.warn("<Clue> was created without expected prop 'direction'");
    		}

    		if (clue === undefined && !('clue' in $$props || $$self.$$.bound[$$self.$$.props['clue']])) {
    			console_1$1.warn("<Clue> was created without expected prop 'clue'");
    		}

    		if (custom === undefined && !('custom' in $$props || $$self.$$.bound[$$self.$$.props['custom']])) {
    			console_1$1.warn("<Clue> was created without expected prop 'custom'");
    		}

    		if (isFilled === undefined && !('isFilled' in $$props || $$self.$$.bound[$$self.$$.props['isFilled']])) {
    			console_1$1.warn("<Clue> was created without expected prop 'isFilled'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Clue> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('clue' in $$props) $$invalidate(12, clue = $$props.clue);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('clueClass' in $$props) $$invalidate(7, clueClass = $$props.clueClass);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*direction, number*/ 3072) {
    			$$invalidate(7, clueClass = `clue--${direction}--${number}`);
    		}
    	};
    ...
    // (43:4) {#each ['across', 'down'] as direction}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(43:4) {#each ['across', 'down'] as direction}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "message svelte-etlrs7");
    			add_location(div0, file$3, 26, 6, 581);
    			attr_dev(div1, "class", "content svelte-etlrs7");
    			add_location(div1, file$3, 25, 4, 553);
    			attr_dev(div2, "class", "completed svelte-etlrs7");
    			add_location(div2, file$3, 24, 2, 495);
    			attr_dev(div3, "class", "curtain svelte-etlrs7");
    			add_location(div3, file$3, 42, 2, 906);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div3, "click", /*close*/ ctx[3], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			button = claim_element(nodes, "BUTTON", { class: true });
    			var button_nodes = children(button);
    			t = claim_text(button_nodes, "View puzzle");
    			button_nodes.forEach(detach_dev);
    			this.h();
    		},
    		h: function hydrate() {
    			attr_dev(button, "class", "svelte-etlrs7");
    			add_location(button, file$3, 31, 8, 668);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, button, anchor);
    			append_hydration_dev(button, t);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "confetti svelte-etlrs7");
    			add_location(div, file$3, 36, 6, 769);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    const get_toolbar_slot_context = ctx => ({
    	onClear: /*onClear*/ ctx[28],
    	onReveal: /*onReveal*/ ctx[29],
    	onCheck: /*onCheck*/ ctx[30]
    });
    ...
    function create_if_block(ctx) {
    	...
    	let current;
    	const toolbar_slot_template = /*#slots*/ ctx[40].toolbar;
    	const toolbar_slot = create_slot(toolbar_slot_template, ctx, /*$$scope*/ ctx[49], get_toolbar_slot_context);
    	const toolbar_slot_or_fallback = toolbar_slot || fallback_block_2(ctx);

    	function clues_1_focusedCellIndex_binding(value) {
    		/*clues_1_focusedCellIndex_binding*/ ctx[41](value);
    	}

    	function clues_1_focusedCell_binding(value) {
    		/*clues_1_focusedCell_binding*/ ctx[42](value);
    	}

    	function clues_1_focusedDirection_binding(value) {
    		/*clues_1_focusedDirection_binding*/ ctx[43](value);
    	}

    	let clues_1_props = {
    		clues: /*clues*/ ctx[8],
    		cellIndexMap: /*cellIndexMap*/ ctx[25],
    		stacked: /*stacked*/ ctx[23],
    		isDisableHighlight: /*isDisableHighlight*/ ctx[24],
    	...
    	if (/*focusedCell*/ ctx[26] !== void 0) {
    		clues_1_props.focusedCell = /*focusedCell*/ ctx[26];
    	}
    	...
    	function puzzle_cells_binding(value) {
    		/*puzzle_cells_binding*/ ctx[44](value);
    	}

    	function puzzle_focusedCellIndex_binding(value) {
    		/*puzzle_focusedCellIndex_binding*/ ctx[45](value);
    	}

    	function puzzle_focusedDirection_binding(value) {
    		/*puzzle_focusedDirection_binding*/ ctx[46](value);
    	}

    	let puzzle_props = {
    		clues: /*clues*/ ctx[8],
    		focusedCell: /*focusedCell*/ ctx[26],
    	...
    	let if_block0 = /*isComplete*/ ctx[10] && !/*isRevealing*/ ctx[15] && /*showCompleteMessage*/ ctx[2] && create_if_block_2(ctx);
    	let if_block1 = !/*isComplete*/ ctx[10] && !/*isRevealing*/ ctx[15] && !/*isSubscribe*/ ctx[27] && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "play svelte-353ha1");
    			toggle_class(div, "stacked", /*stacked*/ ctx[23]);
    			toggle_class(div, "is-loaded", /*isLoaded*/ ctx[16]);
    			add_location(div, file$1, 197, 4, 5308);
    			attr_dev(article, "class", "svelte-crossword svelte-353ha1");
    			attr_dev(article, "style", /*inlineStyles*/ ctx[22]);
    			add_render_callback(() => /*article_elementresize_handler*/ ctx[48].call(article));
    			add_location(article, file$1, 183, 2, 4909);
    		},
    		m: function mount(target, anchor) {
    			...
    			article_resize_listener = add_iframe_resize_listener(article, /*article_elementresize_handler*/ ctx[48].bind(article));
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			if (toolbar_slot) {
    				if (toolbar_slot.p && (!current || dirty[1] & /*$$scope*/ 262144)) {
    					update_slot_base(
    						toolbar_slot,
    						...
    						: get_slot_changes(toolbar_slot_template, /*$$scope*/ ctx[49], dirty, get_toolbar_slot_changes),
    			...
    			if (dirty[0] & /*cellIndexMap*/ 33554432) clues_1_changes.cellIndexMap = /*cellIndexMap*/ ctx[25];
    			if (dirty[0] & /*stacked*/ 8388608) clues_1_changes.stacked = /*stacked*/ ctx[23];
    			if (dirty[0] & /*isDisableHighlight*/ 16777216) clues_1_changes.isDisableHighlight = /*isDisableHighlight*/ ctx[24];
    			...
    			if (!updating_focusedCell && dirty[0] & /*focusedCell*/ 67108864) {
    				updating_focusedCell = true;
    				clues_1_changes.focusedCell = /*focusedCell*/ ctx[26];
    			...
    			if (dirty[0] & /*focusedCell*/ 67108864) puzzle_changes.focusedCell = /*focusedCell*/ ctx[26];
    			...
    			if (dirty[0] & /*isDisableHighlight*/ 16777216) puzzle_changes.isDisableHighlight = /*isDisableHighlight*/ ctx[24];
    			...
    			if (dirty[0] & /*stacked*/ 8388608) puzzle_changes.stacked = /*stacked*/ ctx[23];
    			...
    			if (!current || dirty[0] & /*stacked*/ 8388608) {
    				toggle_class(div, "stacked", /*stacked*/ ctx[23]);
    			}
    			...
    			if (!/*isComplete*/ ctx[10] && !/*isRevealing*/ ctx[15] && !/*isSubscribe*/ ctx[27]) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);
    ...
    function fallback_block_2(ctx) {
    	...
    	toolbar.$on("event", /*onToolbarEvent*/ ctx[31]);
    ...
    // (225:4) {#if isComplete && !isRevealing && showCompleteMessage}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(225:4) {#if isComplete && !isRevealing && showCompleteMessage}",
    		ctx
    	});
    ...
    function fallback_block_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h3, "class", "svelte-353ha1");
    			add_location(h3, file$1, 227, 10, 6276);
    		},
    		m: function mount(target, anchor) {
    ...
    // (226:6) <CompletedMessage showConfetti="{showConfetti}">
    function create_default_slot_1(ctx) {
    	let current;
    	const message_slot_template = /*#slots*/ ctx[40].message;
    	const message_slot = create_slot(message_slot_template, ctx, /*$$scope*/ ctx[49], get_message_slot_context);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (message_slot) {
    				if (message_slot.p && (!current || dirty[1] & /*$$scope*/ 262144)) {
    					update_slot_base(
    						message_slot,
    						...
    						!current
    						? get_all_dirty_from_scope(/*$$scope*/ ctx[49])
    						: get_slot_changes(message_slot_template, /*$$scope*/ ctx[49], dirty, get_message_slot_changes),
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(226:6) <CompletedMessage showConfetti=\\\"{showConfetti}\\\">",
    		ctx
    	});
    ...
    // (233:4) {#if !isComplete && !isRevealing && !isSubscribe}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*subscribe_error, subscribe_email*/ 1572864 | dirty[1] & /*$$scope*/ 262144) {
    				completedmessage_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(233:4) {#if !isComplete && !isRevealing && !isSubscribe}",
    		ctx
    	});
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(br, file$1, 238, 53, 6730);
    			attr_dev(strong, "class", "svelte-353ha1");
    			add_location(strong, file$1, 239, 24, 6759);
    			attr_dev(h3, "class", "svelte-353ha1");
    			add_location(h3, file$1, 237, 12, 6672);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Email");
    			attr_dev(input, "class", "svelte-353ha1");
    			add_location(input, file$1, 241, 12, 6815);
    			attr_dev(div0, "class", "error__tips svelte-353ha1");
    			toggle_class(div0, "active", /*subscribe_error*/ ctx[20]);
    			add_location(div0, file$1, 242, 12, 6949);
    			attr_dev(div1, "class", "crossword_subscribe_submit svelte-353ha1");
    			add_location(div1, file$1, 243, 12, 7034);
    			...
    			add_location(path0, file$1, 249, 14, 7319);
    			...
    			add_location(path1, file$1, 250, 14, 7866);
    			...
    			add_location(path2, file$1, 251, 14, 8077);
    			...
    			add_location(path3, file$1, 252, 14, 8401);
    			...
    			add_location(path4, file$1, 253, 14, 8672);
    			...
    			add_location(path5, file$1, 254, 14, 8899);
    			...
    			add_location(path6, file$1, 255, 14, 9242);
    			...
    			add_location(path7, file$1, 256, 14, 9580);
    			...
    			add_location(path8, file$1, 257, 14, 9812);
    			...
    			add_location(path9, file$1, 258, 14, 10105);
    			...
    			add_location(path10, file$1, 259, 14, 10364);
    			...
    			add_location(path11, file$1, 260, 14, 10636);
    			...
    			add_location(path12, file$1, 261, 14, 10989);
    			...
    			add_location(path13, file$1, 262, 14, 11175);
    			...
    			add_location(path14, file$1, 263, 14, 11524);
    			...
    			add_location(path15, file$1, 264, 14, 11671);
    			...
    			add_location(path16, file$1, 265, 14, 11882);
    			...
    			add_location(path17, file$1, 266, 14, 12171);
    			...
    			add_location(path18, file$1, 267, 14, 12365);
    			...
    			add_location(path19, file$1, 268, 14, 12550);
    			...
    			add_location(path20, file$1, 269, 14, 12713);
    			...
    			add_location(path21, file$1, 270, 14, 12924);
    			...
    			add_location(path22, file$1, 271, 14, 13327);
    			...
    			add_location(path23, file$1, 272, 14, 13504);
    			...
    			add_location(path24, file$1, 273, 14, 13932);
    			...
    			add_location(path25, file$1, 274, 14, 14140);
    			...
    			add_location(path26, file$1, 275, 14, 14479);
    			...
    			add_location(path27, file$1, 276, 14, 14764);
    			attr_dev(svg, "class", "crossword_subscribe_icon svelte-353ha1");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "width", "101");
    			attr_dev(svg, "height", "178");
    			attr_dev(svg, "viewBox", "0 0 101 178");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$1, 248, 12, 7172);
    			attr_dev(div2, "class", "crossword_subscribe_container svelte-353ha1");
    			add_location(div2, file$1, 236, 10, 6616);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div2, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "input", /*handleEmail*/ ctx[32], false, false, false, false),
    					listen_dev(input, "change", /*handleEmail*/ ctx[32], false, false, false, false),
    					listen_dev(input, "input", /*input_input_handler*/ ctx[47]),
    					listen_dev(div1, "click", /*handSubscribe*/ ctx[33], false, false, false, false)
    				];
    ...
    // (235:6) <CompletedMessage showConfetti="{false}" outClickClose="{false}" funcClose="{subscribeModalClose}">
    function create_default_slot(ctx) {
    	let current;
    	const message_slot_template = /*#slots*/ ctx[40].message;
    	const message_slot = create_slot(message_slot_template, ctx, /*$$scope*/ ctx[49], get_message_slot_context_1);
    			...
    			if (message_slot) {
    				if (message_slot.p && (!current || dirty[1] & /*$$scope*/ 262144)) {
    					update_slot_base(
    						...
    						!current
    						? get_all_dirty_from_scope(/*$$scope*/ ctx[49])
    						: get_slot_changes(message_slot_template, /*$$scope*/ ctx[49], dirty, get_message_slot_changes_1),
    						get_message_slot_context_1
    					);
    				}
    			} else {
    				if (message_slot_or_fallback && message_slot_or_fallback.p && (!current || dirty[0] & /*subscribe_error, subscribe_email*/ 1572864)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(235:6) <CompletedMessage showConfetti=\\\"{false}\\\" outClickClose=\\\"{false}\\\" funcClose=\\\"{subscribeModalClose}\\\">",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function clues_1_focusedCell_binding(value) {
    		focusedCell = value;
    		(($$invalidate(26, focusedCell), $$invalidate(9, cells)), $$invalidate(7, focusedCellIndex));
    	}
    	...
    	$$self.$$set = $$props => {
    		if ('data' in $$props) $$invalidate(35, data = $$props.data);
    		if ('actions' in $$props) $$invalidate(0, actions = $$props.actions);
    		if ('theme' in $$props) $$invalidate(36, theme = $$props.theme);
    		if ('revealDuration' in $$props) $$invalidate(1, revealDuration = $$props.revealDuration);
    		if ('breakpoint' in $$props) $$invalidate(37, breakpoint = $$props.breakpoint);
    		if ('revealed' in $$props) $$invalidate(34, revealed = $$props.revealed);
    		if ('disableHighlight' in $$props) $$invalidate(38, disableHighlight = $$props.disableHighlight);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('isSubscribe' in $$props) $$invalidate(27, isSubscribe = $$props.isSubscribe);
    		...
    		if ('inlineStyles' in $$props) $$invalidate(22, inlineStyles = $$props.inlineStyles);
    		if ('stacked' in $$props) $$invalidate(23, stacked = $$props.stacked);
    		if ('isComplete' in $$props) $$invalidate(10, isComplete = $$props.isComplete);
    		if ('isDisableHighlight' in $$props) $$invalidate(24, isDisableHighlight = $$props.isDisableHighlight);
    		if ('percentCorrect' in $$props) $$invalidate(39, percentCorrect = $$props.percentCorrect);
    		if ('cellIndexMap' in $$props) $$invalidate(25, cellIndexMap = $$props.cellIndexMap);
    		if ('focusedCell' in $$props) $$invalidate(26, focusedCell = $$props.focusedCell);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[1] & /*data*/ 16) {
    			(onDataUpdate());
    		}

    		if ($$self.$$.dirty[0] & /*cells, focusedCellIndex*/ 640) {
    			$$invalidate(26, focusedCell = cells[focusedCellIndex] || {});
    		}

    		if ($$self.$$.dirty[0] & /*cells*/ 512) {
    			$$invalidate(25, cellIndexMap = fromPairs(cells.map(cell => [cell.id, cell.index])));
    		}

    		if ($$self.$$.dirty[0] & /*cells*/ 512) {
    			$$invalidate(39, percentCorrect = cells.filter(d => d.answer === d.value).length / cells.length);
    		}

    		if ($$self.$$.dirty[1] & /*percentCorrect*/ 256) {
    			$$invalidate(10, isComplete = percentCorrect == 1);
    		}

    		if ($$self.$$.dirty[0] & /*isComplete*/ 1024 | $$self.$$.dirty[1] & /*disableHighlight*/ 128) {
    			$$invalidate(24, isDisableHighlight = isComplete && disableHighlight);
    		}
    		...
    		if ($$self.$$.dirty[0] & /*cells, clues*/ 768) {
    			($$invalidate(34, revealed = !clues.filter(d => !d.isCorrect).length));
    		}

    		if ($$self.$$.dirty[0] & /*width*/ 64 | $$self.$$.dirty[1] & /*breakpoint*/ 64) {
    			$$invalidate(23, stacked = width < breakpoint);
    		}

    		if ($$self.$$.dirty[1] & /*theme*/ 32) {
