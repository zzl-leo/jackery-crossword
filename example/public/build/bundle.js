...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file$3, 19, 6, 444);
    			attr_dev(button, "class", "svelte-hm3hg2");
    			add_location(button, file$3, 23, 6, 503);
    			attr_dev(div1, "class", "content svelte-hm3hg2");
    			add_location(div1, file$3, 18, 4, 416);
    			attr_dev(div2, "class", "completed svelte-hm3hg2");
    			add_location(div2, file$3, 17, 2, 358);
    			attr_dev(div3, "class", "curtain svelte-hm3hg2");
    			add_location(div3, file$3, 33, 2, 729);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button, "click", /*close*/ ctx[2], false, false, false, false),
    					listen_dev(div3, "click", /*close*/ ctx[2], false, false, false, false)
    				];
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$3, 27, 6, 592);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	return [showConfetti, isOpen, close, $$scope, slots];
    }

    class CompletedMessage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { showConfetti: 0 });
    ...
    const get_toolbar_slot_context = ctx => ({
    	onClear: /*onClear*/ ctx[24],
    	onReveal: /*onReveal*/ ctx[25],
    	onCheck: /*onCheck*/ ctx[26]
    });
    ...
    function create_if_block(ctx) {
    	...
    	let current;
    	const toolbar_slot_template = /*#slots*/ ctx[34].toolbar;
    	...
    	function clues_1_focusedCellIndex_binding(value) {
    		/*clues_1_focusedCellIndex_binding*/ ctx[35](value);
    	}

    	function clues_1_focusedCell_binding(value) {
    		/*clues_1_focusedCell_binding*/ ctx[36](value);
    	}

    	function clues_1_focusedDirection_binding(value) {
    		/*clues_1_focusedDirection_binding*/ ctx[37](value);
    	}

    	let clues_1_props = {
    		clues: /*clues*/ ctx[8],
    		cellIndexMap: /*cellIndexMap*/ ctx[22],
    		stacked: /*stacked*/ ctx[20],
    	...
    	if (/*focusedCell*/ ctx[23] !== void 0) {
    		clues_1_props.focusedCell = /*focusedCell*/ ctx[23];
    	}
    	...
    	function puzzle_cells_binding(value) {
    		/*puzzle_cells_binding*/ ctx[38](value);
    	}

    	function puzzle_focusedCellIndex_binding(value) {
    		/*puzzle_focusedCellIndex_binding*/ ctx[39](value);
    	}

    	function puzzle_focusedDirection_binding(value) {
    		/*puzzle_focusedDirection_binding*/ ctx[40](value);
    	}

    	let puzzle_props = {
    		clues: /*clues*/ ctx[8],
    		focusedCell: /*focusedCell*/ ctx[23],
    	...
    	let if_block = /*isComplete*/ ctx[10] && !/*isRevealing*/ ctx[15] && /*showCompleteMessage*/ ctx[2] && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "play svelte-1tm6rry");
    			toggle_class(div, "stacked", /*stacked*/ ctx[20]);
    			toggle_class(div, "is-loaded", /*isLoaded*/ ctx[16]);
    			add_location(div, file$1, 172, 4, 4683);
    			attr_dev(article, "class", "svelte-crossword svelte-1tm6rry");
    			attr_dev(article, "style", /*inlineStyles*/ ctx[19]);
    			add_render_callback(() => /*article_elementresize_handler*/ ctx[41].call(article));
    			add_location(article, file$1, 159, 2, 4285);
    		},
    		m: function mount(target, anchor) {
    			...
    			article_resize_listener = add_iframe_resize_listener(article, /*article_elementresize_handler*/ ctx[41].bind(article));
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			if (toolbar_slot) {
    			...
    			if (dirty[0] & /*cellIndexMap*/ 4194304) clues_1_changes.cellIndexMap = /*cellIndexMap*/ ctx[22];
    			if (dirty[0] & /*stacked*/ 1048576) clues_1_changes.stacked = /*stacked*/ ctx[20];
    			...
    			if (!updating_focusedCell && dirty[0] & /*focusedCell*/ 8388608) {
    				updating_focusedCell = true;
    				clues_1_changes.focusedCell = /*focusedCell*/ ctx[23];
    			...
    			if (dirty[0] & /*focusedCell*/ 8388608) puzzle_changes.focusedCell = /*focusedCell*/ ctx[23];
    			...
    			if (dirty[0] & /*stacked*/ 1048576) puzzle_changes.stacked = /*stacked*/ ctx[20];
    			...
    			if (!current || dirty[0] & /*stacked*/ 1048576) {
    				toggle_class(div, "stacked", /*stacked*/ ctx[20]);
    			}
    			...
    			if (!current || dirty[0] & /*inlineStyles*/ 524288) {
    				attr_dev(article, "style", /*inlineStyles*/ ctx[19]);
    			}
    		},
    		i: function intro(local) {
    ...
    function fallback_block_1(ctx) {
    	...
    	toolbar.$on("event", /*onToolbarEvent*/ ctx[27]);
    ...
    // (200:4) {#if isComplete && !isRevealing && showCompleteMessage}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(200:4) {#if isComplete && !isRevealing && showCompleteMessage}",
    		ctx
    	});
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h3, "class", "svelte-1tm6rry");
    			add_location(h3, file$1, 202, 10, 5651);
    		},
    		m: function mount(target, anchor) {
    ...
    // (201:6) <CompletedMessage showConfetti="{showConfetti}">
    function create_default_slot(ctx) {
    	let current;
    	const message_slot_template = /*#slots*/ ctx[34].message;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(201:6) <CompletedMessage showConfetti=\\\"{showConfetti}\\\">",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function clues_1_focusedCell_binding(value) {
    		focusedCell = value;
    		(($$invalidate(23, focusedCell), $$invalidate(9, cells)), $$invalidate(7, focusedCellIndex));
    	}
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('actions' in $$props) $$invalidate(0, actions = $$props.actions);
    		if ('theme' in $$props) $$invalidate(30, theme = $$props.theme);
    		if ('revealDuration' in $$props) $$invalidate(1, revealDuration = $$props.revealDuration);
    		if ('breakpoint' in $$props) $$invalidate(31, breakpoint = $$props.breakpoint);
    		if ('revealed' in $$props) $$invalidate(28, revealed = $$props.revealed);
    		if ('disableHighlight' in $$props) $$invalidate(32, disableHighlight = $$props.disableHighlight);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('inlineStyles' in $$props) $$invalidate(19, inlineStyles = $$props.inlineStyles);
    		if ('stacked' in $$props) $$invalidate(20, stacked = $$props.stacked);
    		if ('isComplete' in $$props) $$invalidate(10, isComplete = $$props.isComplete);
    		if ('isDisableHighlight' in $$props) $$invalidate(21, isDisableHighlight = $$props.isDisableHighlight);
    		if ('percentCorrect' in $$props) $$invalidate(33, percentCorrect = $$props.percentCorrect);
    		if ('cellIndexMap' in $$props) $$invalidate(22, cellIndexMap = $$props.cellIndexMap);
    		if ('focusedCell' in $$props) $$invalidate(23, focusedCell = $$props.focusedCell);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*cells, focusedCellIndex*/ 640) {
    			$$invalidate(23, focusedCell = cells[focusedCellIndex] || {});
    		}

    		if ($$self.$$.dirty[0] & /*cells*/ 512) {
    			$$invalidate(22, cellIndexMap = fromPairs(cells.map(cell => [cell.id, cell.index])));
    		}

    		if ($$self.$$.dirty[0] & /*cells*/ 512) {
    			$$invalidate(33, percentCorrect = cells.filter(d => d.answer === d.value).length / cells.length);
    		}

    		if ($$self.$$.dirty[1] & /*percentCorrect*/ 4) {
    			$$invalidate(10, isComplete = percentCorrect == 1);
    		}

    		if ($$self.$$.dirty[0] & /*isComplete*/ 1024 | $$self.$$.dirty[1] & /*disableHighlight*/ 2) {
    		...
    		if ($$self.$$.dirty[0] & /*cells, clues*/ 768) {
    			($$invalidate(28, revealed = !clues.filter(d => !d.isCorrect).length));
    		}

    		if ($$self.$$.dirty[0] & /*width*/ 64 | $$self.$$.dirty[1] & /*breakpoint*/ 1) {
    			$$invalidate(20, stacked = width < breakpoint);
    		}

    		if ($$self.$$.dirty[0] & /*theme*/ 1073741824) {
    			$$invalidate(19, inlineStyles = themes[theme]);
    		}
    	};
