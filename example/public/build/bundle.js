var app = (function () {
    ...
    function create_if_block_2$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(button, file$b, 16, 6, 556);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*btn_check*/ 4) set_data_dev(t, /*btn_check*/ ctx[2]);
    		},
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(button, "class", "svelte-1awe1n5");
    			add_location(button, file$b, 12, 6, 320);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, button, anchor);
    			append_hydration_dev(button, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*btn_reset*/ 2) set_data_dev(t, /*btn_reset*/ ctx[1]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(button);
    			mounted = false;
    ...
    function create_each_block$5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(11:2) {#each actions as action}",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$b, 9, 0, 235);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['actions', 'btn_reset', 'btn_check'];
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(line, "x2", "1");
    			attr_dev(line, "y2", "0");
    			attr_dev(line, "class", "svelte-1w6qrpv");
    			add_location(line, file$9, 108, 4, 2576);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(text_1, "class", "value svelte-1w6qrpv");
    			attr_dev(text_1, "x", "0.5");
    			attr_dev(text_1, "y", "0.75");
    			attr_dev(text_1, "text-anchor", "middle");
    			add_location(text_1, file$9, 112, 4, 2649);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(rect, "class", "svelte-1w6qrpv");
    			add_location(rect, file$9, 105, 2, 2494);
    			attr_dev(text_1, "class", "number svelte-1w6qrpv");
    			attr_dev(text_1, "x", "0.08");
    			attr_dev(text_1, "y", "0.3");
    			attr_dev(text_1, "text-anchor", "start");
    			add_location(text_1, file$9, 121, 2, 2864);
    			attr_dev(g, "class", g_class_value = "cell " + /*custom*/ ctx[4] + " cell-" + /*x*/ ctx[0] + "-" + /*y*/ ctx[1] + " svelte-1w6qrpv");
    			...
    			add_location(g, file$9, 94, 0, 2131);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*custom, x, y*/ 19 && g_class_value !== (g_class_value = "cell " + /*custom*/ ctx[4] + " cell-" + /*x*/ ctx[0] + "-" + /*y*/ ctx[1] + " svelte-1w6qrpv")) {
    ...
    // (220:4) {#each cells as { x, y, value, answer, index, number, custom }}
    function create_each_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(220:4) {#each cells as { x, y, value, answer, index, number, custom }}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "keyboard keyboard-container svelte-bjby6s");
    			add_location(div, file$8, 244, 2, 7723);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(244:0) {#if keyboardVisible}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(svg, "class", "svelte-bjby6s");
    			add_location(svg, file$8, 218, 2, 6804);
    			attr_dev(section, "class", "puzzle svelte-bjby6s");
    			toggle_class(section, "stacked", /*stacked*/ ctx[5]);
    			toggle_class(section, "is-loaded", /*isLoaded*/ ctx[7]);
    			add_location(section, file$8, 213, 0, 6699);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Puzzle> was created with unknown prop '${key}'`);
    	});
    ...
    var tips = [
    	{
    		title: "Mot: LEADERMONDIAL",
    		des: "Jackery est profondément impliqué dans l'industrie du stockage d'énergie depuis 11 ans, avec plus de 3 millions de produits vendus et le soutien de plus de 200 médias."
    	},
    	{
    		title: "Mot: STATIONÉLECTRIQUE",
    		des: "Les stations électriques Jackery répondent à vos besoins d'énergie différents, fournissant de l’énergie à vos appareils électroménagers, réfrigérateurs et plus encore."
    	},
    	{
    		title: "Mot: CAMPING",
    		des: "Les générateurs solaires Jackery sont utilisés pour le camping, fournissant une alimentation portable pour votre équipement extérieur comme le mini-réfrigérateur, le gril électrique et l'airfryer !"
    	},
    	{
    		title: "Mot: ÉNERGIESOLAIRE",
    		des: "Un système d'énergie solaire qui combine une station électrique portable et des panneaux solaires. Il n'émet aucun gaz toxique et fonctionne de manière extrêmement propre, sans nuire à l'environnement."
    	},
    	{
    		title: "Mot: GARANTIELONGUE",
    		des: "Technologie innovante de batterie brevetée de Jackery qui améliore efficacement la sécurité et augmente la durée de vie. Une durée longue de garantie garde votre esprit tranquille."
    	},
    	{
    		title: "Mot: RECHARGERAPIDE",
    		des: "Le générateur solaire Jackery offre une efficacité de charge solaire et murale de pointe, garantissant que vous êtes toujours alimenté en déplacement."
    	}
    ];
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(path0, "class", "svelte-1tc2wu4");
    			add_location(path0, file$7, 160, 8, 6779);
    			...
    			attr_dev(path1, "class", "svelte-1tc2wu4");
    			add_location(path1, file$7, 161, 8, 7237);
    			attr_dev(g, "clip-path", "url(#clip0_1554_302)");
    			add_location(g, file$7, 159, 6, 6733);
    			...
    			add_location(rect, file$7, 165, 10, 8524);
    			attr_dev(clipPath, "id", "clip0_1554_302");
    			add_location(clipPath, file$7, 164, 8, 8482);
    			add_location(defs, file$7, 163, 6, 8466);
    			attr_dev(svg, "class", "modal_icon svelte-1tc2wu4");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 28 29");
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$7, 158, 4, 6634);
    			attr_dev(button, "class", button_class_value = "clue " + /*custom*/ ctx[2] + " svelte-1tc2wu4");
    			...
    			add_location(button, file$7, 147, 2, 6276);
    			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[9]) + " svelte-1tc2wu4"));
    			add_location(li, file$7, 146, 0, 6139);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(li, "click", /*click_handler_1*/ ctx[16], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*custom*/ 4 && button_class_value !== (button_class_value = "clue " + /*custom*/ ctx[2] + " svelte-1tc2wu4")) {
    				attr_dev(button, "class", button_class_value);
    			}
    			...
    			if (dirty & /*clueClass*/ 512 && li_class_value !== (li_class_value = "" + (null_to_empty(/*clueClass*/ ctx[9]) + " svelte-1tc2wu4"))) {
    ...
    `;
    	...
    	$$self.$$.on_mount.push(function () {
    		...
    		if (direction === undefined && !('direction' in $$props || $$self.$$.bound[$$self.$$.props['direction']])) {
    			console.warn("<Clue> was created without expected prop 'direction'");
    		}
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:4) {#each ['across', 'down'] as direction}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "clues--stacked svelte-1o7duub");
    			add_location(div0, file$5, 41, 2, 1140);
    			attr_dev(div1, "class", "clues--list svelte-1o7duub");
    			add_location(div1, file$5, 45, 2, 1247);
    			attr_dev(section, "class", "clues svelte-1o7duub");
    			toggle_class(section, "is-loaded", /*isLoaded*/ ctx[3]);
    			add_location(section, file$5, 40, 0, 1085);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, section, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	let if_block2 = /*showConfetti*/ ctx[0] && create_if_block_1$1(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "message svelte-83cmws");
    			add_location(div0, file$3, 61, 6, 2232);
    			attr_dev(div1, "class", "content svelte-83cmws");
    			add_location(div1, file$3, 60, 4, 2204);
    			attr_dev(div2, "class", "footer");
    			add_location(div2, file$3, 79, 4, 2653);
    			attr_dev(div3, "class", "completed svelte-83cmws");
    			toggle_class(div3, "issubscribeModal", /*subscribeModal*/ ctx[4]);
    			add_location(div3, file$3, 51, 2, 1204);
    			attr_dev(div4, "class", "curtain 888 svelte-83cmws");
    			add_location(div4, file$3, 90, 2, 2881);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div4, "click", /*click_handler*/ ctx[13], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block_5$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path, file$3, 57, 191, 1531);
    			attr_dev(svg, "class", "close_icon svelte-83cmws");
    			...
    			add_location(svg, file$3, 57, 4, 1344);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, svg, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(svg, "click", /*close*/ ctx[6], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block_2$1(ctx) {
    	...
    	let if_block1 = !/*btnShopNow*/ ctx[1] && create_if_block_3$1(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(button, "class", "svelte-83cmws");
    			add_location(button, file$3, 66, 8, 2333);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, button, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*close*/ ctx[6], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block_4$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(span, "class", "svelte-83cmws");
    			add_location(span, file$3, 69, 12, 2469);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span, "click", /*handleGTM_shopnow*/ ctx[7], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*success_copy*/ 8) set_data_dev(t, /*success_copy*/ ctx[3]);
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "confetti svelte-83cmws");
    			add_location(div, file$3, 84, 6, 2744);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (success_copy === undefined && !('success_copy' in $$props || $$self.$$.bound[$$self.$$.props['success_copy']])) {
    			console.warn("<CompletedMessage> was created without expected prop 'success_copy'");
    		}

    		if (shopurl === undefined && !('shopurl' in $$props || $$self.$$.bound[$$self.$$.props['shopurl']])) {
    			console.warn("<CompletedMessage> was created without expected prop 'shopurl'");
    		}
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div2, file$2, 28, 0, 678);
    			attr_dev(button1, "class", "check__open svelte-1oqir1l");
    			add_location(button1, file$2, 43, 0, 1078);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", /*openModal*/ ctx[6], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*modal_correct_words*/ 4) set_data_dev(t2, /*modal_correct_words*/ ctx[2]);
    			if (dirty & /*correct_num*/ 1) set_data_dev(t4, /*correct_num*/ ctx[0]);
    			if (dirty & /*modal_incorrect_words*/ 8) set_data_dev(t6, /*modal_incorrect_words*/ ctx[3]);
    			if (dirty & /*error_num*/ 2) set_data_dev(t8, /*error_num*/ ctx[1]);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('modal_correct_words' in $$props) $$invalidate(2, modal_correct_words = $$props.modal_correct_words);
    		if ('modal_incorrect_words' in $$props) $$invalidate(3, modal_incorrect_words = $$props.modal_incorrect_words);
    		if ('modalIn' in $$props) $$invalidate(4, modalIn = $$props.modalIn);
    		if ('out' in $$props) $$invalidate(5, out = $$props.out);
    	};
    ...
    class CheckModal extends SvelteComponentDev {
    	...
    	get modal_correct_words() {
    		throw new Error("<CheckModal>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set modal_correct_words(value) {
    		throw new Error("<CheckModal>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get modal_incorrect_words() {
    		throw new Error("<CheckModal>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set modal_incorrect_words(value) {
    		throw new Error("<CheckModal>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$1, 279, 4, 8453);
    			...
    			add_location(article, file$1, 265, 2, 7900);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(307:4) {#if isComplete && !isRevealing && showCompleteMessage}",
    		ctx
    	});
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file$1, 310, 10, 9689);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*success_title*/ 16384) set_data_dev(t0, /*success_title*/ ctx[14]);
    			if (dirty[1] & /*coupons_code*/ 256) set_data_dev(t4, /*coupons_code*/ ctx[39]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(310:10) {#if coupons_api_error === \\\"\\\"}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$1, 321, 12, 10205);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    			append_hydration_dev(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[1] & /*coupons_api_error*/ 128) set_data_dev(t, /*coupons_api_error*/ ctx[38]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(321:10) {#if coupons_api_error !== \\\"\\\"}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$1, 327, 10, 10399);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(327:10) {#if coupons_api_error === \\\"\\\"}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(334:4) {#if !isComplete && !isRevealing && !isSubscribe}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path, file$1, 369, 171, 12325);
    			...
    			attr_dev(svg, "fill", "currentColor");
    			attr_dev(svg, "aria-hidden", "true");
    			add_location(svg, file$1, 369, 16, 12170);
    			attr_dev(span, "class", "crossword_submit_loading svelte-10vn5u1");
    			add_location(span, file$1, 368, 14, 12113);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, span, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(368:14) {#if subscribeLoading}",
    		ctx
    	});
    ...
    function fallback_block(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*subscribeLoading*/ ctx[37] && create_if_block_2(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path0, file$1, 376, 14, 12917);
    			...
    			add_location(path1, file$1, 377, 14, 13465);
    			...
    			add_location(path2, file$1, 378, 14, 13677);
    			...
    			add_location(path3, file$1, 379, 14, 14002);
    			...
    			add_location(path4, file$1, 380, 14, 14274);
    			...
    			add_location(path5, file$1, 381, 14, 14502);
    			...
    			add_location(path6, file$1, 382, 14, 14846);
    			...
    			add_location(path7, file$1, 383, 14, 15185);
    			...
    			add_location(path8, file$1, 384, 14, 15418);
    			...
    			add_location(path9, file$1, 385, 14, 15712);
    			...
    			add_location(path10, file$1, 386, 14, 15972);
    			...
    			add_location(path11, file$1, 387, 14, 16245);
    			...
    			add_location(path12, file$1, 388, 14, 16599);
    			...
    			add_location(path13, file$1, 389, 14, 16786);
    			...
    			add_location(path14, file$1, 390, 14, 17136);
    			...
    			add_location(path15, file$1, 391, 14, 17284);
    			...
    			add_location(path16, file$1, 392, 14, 17496);
    			...
    			add_location(path17, file$1, 393, 14, 17786);
    			...
    			add_location(path18, file$1, 394, 14, 17981);
    			...
    			add_location(path19, file$1, 395, 14, 18167);
    			...
    			add_location(path20, file$1, 396, 14, 18331);
    			...
    			add_location(path21, file$1, 397, 14, 18543);
    			...
    			add_location(path22, file$1, 398, 14, 18947);
    			...
    			add_location(path23, file$1, 399, 14, 19125);
    			...
    			add_location(path24, file$1, 400, 14, 19554);
    			...
    			add_location(path25, file$1, 401, 14, 19763);
    			...
    			add_location(path26, file$1, 402, 14, 20103);
    			...
    			add_location(path27, file$1, 403, 14, 20389);
    			...
    			attr_dev(svg, "fill", "none");
    			add_location(svg, file$1, 375, 12, 12769);
    			attr_dev(div2, "class", "crossword_subscribe_container svelte-10vn5u1");
    			add_location(div2, file$1, 337, 10, 10842);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div2, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", /*handleEmail*/ ctx[50], false, false, false, false),
    					listen_dev(input0, "change", /*handleEmail*/ ctx[50], false, false, false, false),
    					listen_dev(input0, "input", /*input0_input_handler*/ ctx[70]),
    					listen_dev(input1, "change", /*handleAgree*/ ctx[51], false, false, false, false),
    					listen_dev(input1, "change", /*input1_change_handler*/ ctx[71]),
    					listen_dev(div1, "click", /*handSubscribe*/ ctx[52], false, false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*modal_email_policy*/ 256) span2.innerHTML = /*modal_email_policy*/ ctx[8];			if (dirty[1] & /*subscribe_error_txt*/ 16) set_data_dev(t5, /*subscribe_error_txt*/ ctx[35]);

    			if (dirty[1] & /*subscribe_error*/ 8) {
    				toggle_class(div0, "active", /*subscribe_error*/ ctx[34]);
    			}

    			if (dirty[0] & /*modal_email_playnow*/ 512) set_data_dev(t7, /*modal_email_playnow*/ ctx[9]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		...
    		if (modal_correct_words === undefined && !('modal_correct_words' in $$props || $$self.$$.bound[$$self.$$.props['modal_correct_words']])) {
    			console.warn("<Crossword> was created without expected prop 'modal_correct_words'");
    		}

    		if (modal_incorrect_words === undefined && !('modal_incorrect_words' in $$props || $$self.$$.bound[$$self.$$.props['modal_incorrect_words']])) {
    			console.warn("<Crossword> was created without expected prop 'modal_incorrect_words'");
    		}

    		if (btn_reset === undefined && !('btn_reset' in $$props || $$self.$$.bound[$$self.$$.props['btn_reset']])) {
    			console.warn("<Crossword> was created without expected prop 'btn_reset'");
    		}

    		if (btn_check === undefined && !('btn_check' in $$props || $$self.$$.bound[$$self.$$.props['btn_check']])) {
    			console.warn("<Crossword> was created without expected prop 'btn_check'");
    		}

    		if (success_title === undefined && !('success_title' in $$props || $$self.$$.bound[$$self.$$.props['success_title']])) {
    			console.warn("<Crossword> was created without expected prop 'success_title'");
    		}

    		if (success_couponinfo === undefined && !('success_couponinfo' in $$props || $$self.$$.bound[$$self.$$.props['success_couponinfo']])) {
    			console.warn("<Crossword> was created without expected prop 'success_couponinfo'");
    		}

    		if (success_copy === undefined && !('success_copy' in $$props || $$self.$$.bound[$$self.$$.props['success_copy']])) {
    			console.warn("<Crossword> was created without expected prop 'success_copy'");
    		}

    		if (success_des === undefined && !('success_des' in $$props || $$self.$$.bound[$$self.$$.props['success_des']])) {
    			console.warn("<Crossword> was created without expected prop 'success_des'");
    		}

    		if (shopurl === undefined && !('shopurl' in $$props || $$self.$$.bound[$$self.$$.props['shopurl']])) {
    			console.warn("<Crossword> was created without expected prop 'shopurl'");
    		}

    		if (setting_id === undefined && !('setting_id' in $$props || $$self.$$.bound[$$self.$$.props['setting_id']])) {
    			console.warn("<Crossword> was created without expected prop 'setting_id'");
    		}
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('shopurl' in $$props) $$invalidate(18, shopurl = $$props.shopurl);
    		if ('setting_id' in $$props) $$invalidate(61, setting_id = $$props.setting_id);
    		if ('checkModal' in $$props) $$invalidate(24, checkModal = $$props.checkModal);
    		if ('error_num' in $$props) $$invalidate(25, error_num = $$props.error_num);
    		if ('correct_num' in $$props) $$invalidate(26, correct_num = $$props.correct_num);
    		if ('width' in $$props) $$invalidate(19, width = $$props.width);
    		if ('focusedDirection' in $$props) $$invalidate(27, focusedDirection = $$props.focusedDirection);
    		if ('focusedCellIndex' in $$props) $$invalidate(20, focusedCellIndex = $$props.focusedCellIndex);
    		if ('isRevealing' in $$props) $$invalidate(28, isRevealing = $$props.isRevealing);
    		if ('isLoaded' in $$props) $$invalidate(29, isLoaded = $$props.isLoaded);
    		if ('isChecking' in $$props) $$invalidate(30, isChecking = $$props.isChecking);
    		...
    		if ('validated' in $$props) $$invalidate(31, validated = $$props.validated);
    		if ('clues' in $$props) $$invalidate(21, clues = $$props.clues);
    		if ('cells' in $$props) $$invalidate(22, cells = $$props.cells);
    		if ('isSubscribe' in $$props) $$invalidate(45, isSubscribe = $$props.isSubscribe);
    		if ('subscribe_email' in $$props) $$invalidate(32, subscribe_email = $$props.subscribe_email);
    		if ('subscribe_agree' in $$props) $$invalidate(33, subscribe_agree = $$props.subscribe_agree);
    		if ('subscribe_error' in $$props) $$invalidate(34, subscribe_error = $$props.subscribe_error);
    		if ('subscribe_error_txt' in $$props) $$invalidate(35, subscribe_error_txt = $$props.subscribe_error_txt);
    		if ('subscribeModalClose' in $$props) $$invalidate(36, subscribeModalClose = $$props.subscribeModalClose);
    		if ('subscribeLoading' in $$props) $$invalidate(37, subscribeLoading = $$props.subscribeLoading);
    		if ('coupons_api_error' in $$props) $$invalidate(38, coupons_api_error = $$props.coupons_api_error);
    		if ('coupons_code' in $$props) $$invalidate(39, coupons_code = $$props.coupons_code);
    		if ('isComplete' in $$props) $$invalidate(23, isComplete = $$props.isComplete);
    		if ('inlineStyles' in $$props) $$invalidate(40, inlineStyles = $$props.inlineStyles);
    		if ('stacked' in $$props) $$invalidate(41, stacked = $$props.stacked);
    		if ('isDisableHighlight' in $$props) $$invalidate(42, isDisableHighlight = $$props.isDisableHighlight);
    		if ('percentCorrect' in $$props) $$invalidate(62, percentCorrect = $$props.percentCorrect);
    		if ('cellIndexMap' in $$props) $$invalidate(43, cellIndexMap = $$props.cellIndexMap);
    		if ('focusedCell' in $$props) $$invalidate(44, focusedCell = $$props.focusedCell);
    	};
    ...
    class Crossword extends SvelteComponentDev {
    	...
    	set modal_email(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get modal_email_empty() {
    		throw new Error("<Crossword>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set modal_email_empty(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get modal_email_error() {
    		throw new Error("<Crossword>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set modal_email_error(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get modal_email_noagree() {
    		throw new Error("<Crossword>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set modal_email_noagree(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get modal_email_policy() {
    		throw new Error("<Crossword>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set modal_email_policy(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get modal_email_playnow() {
    		throw new Error("<Crossword>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set modal_email_playnow(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    	...
    	set success_title(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get success_couponinfo() {
    		throw new Error("<Crossword>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set success_couponinfo(value) {
    		throw new Error("<Crossword>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(section, "class", "svelte-1lk4vsn");
    			add_location(section, file, 33, 2, 783);
    			attr_dev(article, "class", "svelte-1lk4vsn");
    			add_location(article, file, 32, 0, 771);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, article, anchor);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (modal_title === undefined && !('modal_title' in $$props || $$self.$$.bound[$$self.$$.props['modal_title']])) {
    			console.warn("<App> was created without expected prop 'modal_title'");
    		}

    		if (modal_email === undefined && !('modal_email' in $$props || $$self.$$.bound[$$self.$$.props['modal_email']])) {
    			console.warn("<App> was created without expected prop 'modal_email'");
    		}

    		if (modal_email_empty === undefined && !('modal_email_empty' in $$props || $$self.$$.bound[$$self.$$.props['modal_email_empty']])) {
    			console.warn("<App> was created without expected prop 'modal_email_empty'");
    		}

    		if (modal_email_error === undefined && !('modal_email_error' in $$props || $$self.$$.bound[$$self.$$.props['modal_email_error']])) {
    			console.warn("<App> was created without expected prop 'modal_email_error'");
    		}

    		if (modal_email_noagree === undefined && !('modal_email_noagree' in $$props || $$self.$$.bound[$$self.$$.props['modal_email_noagree']])) {
    			console.warn("<App> was created without expected prop 'modal_email_noagree'");
    		}

    		if (modal_email_policy === undefined && !('modal_email_policy' in $$props || $$self.$$.bound[$$self.$$.props['modal_email_policy']])) {
    			console.warn("<App> was created without expected prop 'modal_email_policy'");
    		}

    		if (modal_email_playnow === undefined && !('modal_email_playnow' in $$props || $$self.$$.bound[$$self.$$.props['modal_email_playnow']])) {
    			console.warn("<App> was created without expected prop 'modal_email_playnow'");
    		}

    		if (modal_correct_words === undefined && !('modal_correct_words' in $$props || $$self.$$.bound[$$self.$$.props['modal_correct_words']])) {
    			console.warn("<App> was created without expected prop 'modal_correct_words'");
    		}

    		if (modal_incorrect_words === undefined && !('modal_incorrect_words' in $$props || $$self.$$.bound[$$self.$$.props['modal_incorrect_words']])) {
    			console.warn("<App> was created without expected prop 'modal_incorrect_words'");
    		}

    		if (btn_reset === undefined && !('btn_reset' in $$props || $$self.$$.bound[$$self.$$.props['btn_reset']])) {
    			console.warn("<App> was created without expected prop 'btn_reset'");
    		}

    		if (btn_check === undefined && !('btn_check' in $$props || $$self.$$.bound[$$self.$$.props['btn_check']])) {
    			console.warn("<App> was created without expected prop 'btn_check'");
    		}

    		if (success_title === undefined && !('success_title' in $$props || $$self.$$.bound[$$self.$$.props['success_title']])) {
    			console.warn("<App> was created without expected prop 'success_title'");
    		}

    		if (success_couponinfo === undefined && !('success_couponinfo' in $$props || $$self.$$.bound[$$self.$$.props['success_couponinfo']])) {
    			console.warn("<App> was created without expected prop 'success_couponinfo'");
    		}

    		if (success_copy === undefined && !('success_copy' in $$props || $$self.$$.bound[$$self.$$.props['success_copy']])) {
    			console.warn("<App> was created without expected prop 'success_copy'");
    		}

    		if (success_des === undefined && !('success_des' in $$props || $$self.$$.bound[$$self.$$.props['success_des']])) {
    			console.warn("<App> was created without expected prop 'success_des'");
    		}

    		if (shopurl === undefined && !('shopurl' in $$props || $$self.$$.bound[$$self.$$.props['shopurl']])) {
    			console.warn("<App> was created without expected prop 'shopurl'");
    		}

    		if (setting_id === undefined && !('setting_id' in $$props || $$self.$$.bound[$$self.$$.props['setting_id']])) {
    			console.warn("<App> was created without expected prop 'setting_id'");
    		}
    	});
